...
!function() {
  "use strict"; let c={}; try {
    ...
    !function c(h, l) {
      const v=Object.keys(l).reduce(function(c, h) {
        const v=l[h]; return v.icon?c[v.iconName]=v.icon:c[h]=v, c;
