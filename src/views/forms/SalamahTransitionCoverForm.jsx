                    ...
                    <Form>
                      ...
                      <>
                        ...
                        <div className="pl-lg-4">
                          <h6 className="heading-small text-muted mb-4">
                            Parents
                            {this.state.married ? "/ Parents In Law" : ""} (Max
                            - 4)
                          </h6>
                          <div className="pl-lg-4">
                                    ...
                                    <Col md="6">
                                      <FormGroup>
                                        ...
                                        <Input
                                          ...
                                          id="firstName"
                                          value={
                                            this.state.parents[index].firstName
                                          }
                                          className="form-control-alternative"
                                          onChange={event =>
                                    ...
                                    <Col md="6">
                                      <FormGroup>
                                        ...
                                        <Input
                                          type="date"
                                          id="DOB"
                                          value={this.state.parents[index].DOB}
                                          className="form-control-alternative"
                                          onChange={event =>
                                            this.handleParentChange(
                                              event,
                                    ...
                                    <Col md="6">
                                      <FormGroup>
                                        ...
                                        <Input
                                          ...
                                          id="firstName"
                                          value={
                                            this.state.children[index].firstName
                                          }
                                          className="form-control-alternative"
                                          onChange={event =>
                                    ...
                                    <Col md="6">
                                      <FormGroup>
                                        ...
                                        <Input
                                          ...
                                          id="lastName"
                                          value={
                                            this.state.children[index].lastName
                                          }
                                          className="form-control-alternative"
                                          onChange={event =>
                                            this.handleChildrenChange(
                                    ...
                                    <Col md="6">
                                      <FormGroup>
                                        ...
                                        <Input
                                          type="date"
                                          id="DOB"
                                          value={this.state.children[index].DOB}
                                          className="form-control-alternative"
                                          onChange={event =>
                                            this.handleChildrenChange(
                                              event,
                                    ...
                                    <Col md="6">
                                      <FormGroup>
                                        ...
                                        <Input
                                          ...
                                          id="idNumber"
                                          value={
                                            this.state.children[index].idNumber
                                          }
                                          className="form-control-alternative"
                                          onChange={event =>
                                            this.handleChildrenChange(
